...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.plusone'
        db.add_column('tf_arsfest_registration', 'plusone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.plusone'
        db.delete_column('tf_arsfest_registration', 'plusone')
